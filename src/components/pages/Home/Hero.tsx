...
const Hero = () => {
  ...
  return (
    <>
      <div className="relative min-h-fit lg:min-h-screen pb-8 flex items-center overflow-hidden bg-gradient-to-br from-slate-50 to-white">
        ...
        <div className="container mx-auto px-4 z-10 relative mt-4">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="space-y-8">
              {/* Badge */}
              <div className="inline-flex items-center px-4 mt-14 md:mt-2 py-2 bg-white/20 backdrop-blur-sm rounded-full border border-white/30">
