      ...
      <div className="flex flex-1">
        ...
        <aside className="w-64 bg-gray-100 border-r hidden lg:block">
          <div className="p-6 h-full flex flex-col">
            <h2 className="text-xl font-semibold mb-6 bg-gradient-to-r from-[#1E3A8A] to-[#0253CC] bg-clip-text text-transparent">Amos&nbsp;Joseph</h2>
            ...
            <div className="py-4 mt-4 border-t border-gray-200">
              <Link href="/">
                <Button variant="link" className="w-full justify-start font-medium bg-gradient-to-r from-[#1E3A8A] to-[#0253CC] bg-clip-text text-transparent" size="sm">
