...
import { encryptData, validateEmail, validatePassword, validatePhoneNumber } from "../../../utils/helpers";
...
const SignUpForm: React.FC = () => {
  ...
  const handleSubmitWithDelay = async (e : React.SyntheticEvent<HTMLFormElement>) => {
    e.preventDefault();
    setSubmitting(true);
    ...
    if(!validatePassword(form.password)) {
      toast.error(" Password must contain at least 8 characters, at least 1 capital letter, 1 number and 1 special character ");
      setSubmitting(false);
      return;
    }
  ...
  return (
      <form
        ...
        <h2 className="text-3xl font-playfair font-semibold text-primary mb-1">Create your account</h2>
        ...
        <div>
          ...
          <div className="relative mt-1">
            <Input
              ...
              maxLength={11}
            />
            <Phone size={20} className="absolute left-3 top-[10px] text-purple-400" />
          </div>
        </div>
        <div>
          <Label htmlFor="email" className="text-gray-700 font-medium">
