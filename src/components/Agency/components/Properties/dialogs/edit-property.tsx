...
const PropertyEditForm: React.FC<PropertyEditFormProps> = ({
  ...
  const [_defaultState, setDefaultState] = useState(
    {} as CountryStatesInterface
  );
  ...
  useEffect(() => {
    if (property) {
      ...
      axiosInstance
        .get(
          "country/states/all?countryId=0b7c1c4d-65a5-484d-9b03-8c6b36d09634"
        )
        .then((res) => {
          setCountryStates(res?.data?.data);
          const _defaultState = res?.data?.data?.find(
            ({ id }: CountryStatesInterface) => id === property?.stateId
          );
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <div>
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value={property?.propertyType?.name}>
              ...
              <div>
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value={_defaultState?.name}>
                      {_defaultState?.name}
                    </SelectItem>
                    {countryStates &&
                      countryStates?.map((data: CountryStatesInterface) => (
                        <SelectItem
                          key={Math.random()}
                          className="capitalize"
                          value={data.id}
              ...
              <div className="grid sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                ...
                <div className="flex items-center space-x-3 space-y-0 rounded-lg border p-4">
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("hasCCtv", e.target.checked)
                    }
                  />
                ...
                <div className="flex items-center space-x-3 space-y-0 rounded-lg border p-4">
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("hasLaundry", e.target.checked)
                    }
                  />
                ...
                <div className="flex items-center space-x-3 space-y-0 rounded-lg border p-4">
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("hasKidsPlayArea", e.target.checked)
                    }
                  />
                ...
                <div className="flex items-center space-x-3 space-y-0 rounded-lg border p-4">
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("hasGym", e.target.checked)
                    }
                  />
                ...
                <div className="flex items-center space-x-3 space-y-0 rounded-lg border p-4">
                  <input
                    ...
                    onChange={(e) =>
                      handleInputChange("hasCarParking", e.target.checked)
                    }
                  />
                  <Label className="font-normal cursor-pointer">
                    Car Parking
            ...
            <div className="w-full h-64">
              ...
              <p className="py-1">Upload Property Video</p>
