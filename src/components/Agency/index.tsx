...
export const agentDashboardData = [
  ...
  {
    href: "/agent-dashboard/schedule",
    label: "Schedule",
    id: "schedule",
    icon: Calendar,
  },
  {
    href: "/agent-dashboard/boosts",
    label: "Boost History",
    id: "boosts",
    icon: ZapIcon,
  },
...
const AgentDashboard = () => {
  ...
  const stats = [
    ...
    },
    {
      ...
      value: `${Math.round(
        (agentData.clientsSatisfied / agentData.totalReviews) * 100
      )}%`,
      change: "+2.1%",
      trend: "up",
      icon: Users,
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      setLocalStorageField(
        "agentId",
        feeSetupResponse?.data?.data?.agenciesCreated?.[0]?.id
      );
    };
    fetchData();
  }, []);
                    ...
                    <div>
                      ...
                      <div className="flex items-center gap-4 mt-2">
                        ...
                        <Badge variant="secondary">
                          {agentData.yearsExperience} years experience
                        </Badge>
                      </div>
                    </div>
